...
export const submissions = Object.values(submissionsMap);
export const species = Object.values(speciesMap);
export const locations = Object.values(locationMap);
